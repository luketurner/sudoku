...
Persistence = require './app/persistence.coffee'
...
Events.addService Persistence.service

View.registerEvents()

if not Persistence.loadState() then Events.emit type: "game:new", historical: true
Timer.start()
